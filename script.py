...
if __name__ == "__main__":
    ...
    saved_tracks = sp.current_user_saved_tracks(limit=15, offset=0)
    ...
    sp.playlist_replace_items(playlist_id=playlist_id, items= track_uris[:10] + track_uris[:10] + track_uris[:10] + track_uris)
